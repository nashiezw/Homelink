...
function seedRoommateSeekers(state: ReturnType<typeof createInitialStore>) {
  const profiles: Array<{ userId: string; suburb: string; budgetMin: number; budgetMax: number; gender: string; age: number; lifestyle: string; smoking: boolean; pets: boolean; bio: string; religion: string; maritalStatus: string; genderPreference: string; religionPreference: string; maritalStatusPreference: string; preferredAgeMin: number; preferredAgeMax: number; moveInDate?: string; availableNow?: boolean }> = [
    {
    ...
    },
    {
      ...
      smoking: false,
      pets: false,
      bio: "Muslim professional seeking a respectful, quiet household in northern Harare.",
      religion: "muslim",
  ...
  for (const p of profiles) {
    state.roommateProfiles.set(p.userId, {
      ...
      occupation: p.lifestyle === "student" ? "Student" : "Professional",
