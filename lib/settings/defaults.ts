...
export const defaultPlatformSettings: PlatformSettings = {
  ...
  contact: {
    ...
    whatsappNumber: "",
    whatsappLabel: "",
    whatsappLibraryNumber: "",
    whatsappPropertyNumber: "",
    whatsappAcademyNumber: "",
    stickyWhatsAppEnabled: true,
    stickyWhatsAppMessage: "Hi HouseLink — I need help with a property listing or viewing.",
    stickyWhatsAppLibraryMessage: "Hi HouseLink — I need help with a Library / books order.",
    stickyWhatsAppAcademyMessage: "Hi HouseLink — I need help with HouseLink Academy.",
    stickyWhatsAppLabel: "WhatsApp",
    stickyWhatsAppQuietHours: "We usually reply 8am–6pm CAT",
    officeAddress: "",
    supportHours: "",
  },
  careers: {
