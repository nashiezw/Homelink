...
export const CERTIFICATE_SHORT_DISCLAIMER =
  "This certificate confirms completion of a HouseLink Zimbabwe Academy training programme and does not constitute statutory registration, professional licensing or accreditation by the Estate Agents Council of Zimbabwe or any other regulatory authority.";

export const MARKETPLACE_DISCLAIMER =
  "HouseLink Zimbabwe operates as a property marketplace and platform. It does not assume the statutory functions, legal duties, professional responsibilities, or regulated roles of estate agencies, registered estate agents, conveyancers, valuers, legal practitioners, local authorities, councils, financial institutions, or any other regulated professional or public authority.";
