/** HomeLink Agent Academy — three progressive programmes. */
...
export const ACADEMY_PROGRAMME_COURSES: AcademyProgrammeCourse[] = [
  {
    ...
    slug: "homelink-agent-foundations",
    title: "HomeLink Agent Foundations",
    subtitle: "Professional standards, ethics & industry essentials",
    shortDescription: "Your entry into HomeLink — orientation, conduct, real estate fundamentals, and your starter field toolkit.",
    description: "A comprehensive foundation programme covering HomeLink standards, professional ethics, Zimbabwe real estate essentials, and daily agent routines. Includes branded planners and your Foundations knowledge certification.",
    difficulty: "BEGINNER",
    ...
    badgeName: "HomeLink Foundations Graduate",
    ...
    learningOutcomes: [
      "Understand HomeLink Zimbabwe's marketplace standards and your professional obligations",
  ...
  },
  {
    ...
    slug: "homelink-listing-client-mastery",
    title: "HomeLink Listing & Client Mastery",
    subtitle: "Prospecting, listings, marketing & client service",
    shortDescription: "Win listings, market properties professionally, and master the full client journey with HomeLink-branded field tools.",
    ...
    badgeName: "HomeLink Listing & Client Specialist",
    ...
    learningOutcomes: [
      ...
      "Capture complete, compliant listing data before publishing on HomeLink",
  ...
  },
  {
    ...
    slug: "homelink-professional-certification",
    title: "HomeLink Professional Certification",
    subtitle: "Compliance, performance & complete field toolkit",
    shortDescription: "Advanced compliance, top-performer systems, final examination, and the full HomeLink professional resource kit.",
    description: "The capstone programme covering documentation, legal awareness, performance tracking, and every branded form, checklist, and flowchart in the HomeLink toolkit. Earn full professional agent certification.",
    difficulty: "ADVANCED",
    ...
    badgeName: "HomeLink Certified Professional Agent",
    ...
    learningOutcomes: [
      "Maintain audit-ready client files using HomeLink compliance checklists",
      ...
      "Access and apply the complete HomeLink professional resource kit in the field",
