...
export const ACADEMY_PROGRAMME_COURSES: AcademyProgrammeCourse[] = [
  {
    ...
    description: "A comprehensive foundation programme covering HouseLink standards, professional ethics, Zimbabwe real estate essentials, and daily agent routines. Includes branded planners and your Foundations training certificate.",
    difficulty: "BEGINNER",
    ...
    badgeXp: 250,
    certificateTitle: "Certificate of Completion - HouseLink Agent Foundations",
    ...
    assignmentIds: [
      ...
      "academy-assignment-verification-risk-drill",
    ],
    ...
    learningOutcomes: [
      ...
      "Recognise basic Zimbabwe property risk flags and know when to escalate",
      ...
      "Pass the Foundations knowledge check and earn your first HouseLink training certificate",
    ],
    includes: [
  ...
  },
  {
    ...
    badgeXp: 500,
    certificateTitle: "Certificate of Completion - HouseLink Listing & Client Mastery",
    ...
    assignmentIds: [
      ...
      "academy-assignment-cma-pricing-pack",
      "academy-assignment-listing-roleplay",
      "academy-assignment-viewing-record",
      "academy-assignment-client-qualification-simulation",
      "academy-assignment-offer-negotiation-roleplay",
    ],
    requiresFinalExam: false,
    ...
    learningOutcomes: [
      ...
      "Build a basic CMA and defend pricing recommendations with market evidence",
      ...
      "Qualify buyers and tenants, run safe viewings, and manage offers and counter-offers professionally",
  ...
  },
  {
    ...
    slug: "houselink-professional-training",
    title: "HouseLink Professional Training Programme",
    ...
    description: "The capstone training programme covering documentation, legal awareness, performance tracking, and every branded form, checklist, and flowchart in the HouseLink toolkit. Earn a HouseLink professional training completion certificate.",
    difficulty: "ADVANCED",
    ...
    badgeName: "HouseLink Professional Training Graduate",
    badgeDescription: "Completed the HouseLink professional training programme including compliance assessments and the final examination.",
    badgeXp: 1000,
    certificateTitle: "Certificate of Completion - HouseLink Professional Training",
    ...
    assignmentIds: [
      ...
      "academy-assignment-document-risk-review",
      "academy-assignment-performance-review",
      "academy-assignment-pipeline-coaching-review",
      "academy-assignment-field-portfolio",
    ],
    ...
    learningOutcomes: [
      ...
      "Spot document risk flags and write clear escalation notes",
      ...
      "Maintain annual training renewal evidence and continuing professional development",
      "Access and apply the complete HouseLink professional resource kit in the field",
      "Pass compliance assessments and the HouseLink professional training final examination",
    ],
    includes: [
      ...
      "HouseLink professional training final examination (35 questions, 85% pass mark)",
      "Specialisation pathway planning and annual training renewal requirements",
      "HouseLink Professional Training Graduate badge + downloadable certificate",
    ],
    assessmentSummary: "Complete all training sessions, pass all three module quizzes, earn mentor/admin review on all six assignments, then pass the final examination to earn the HouseLink professional training certificate.",
  },
];
