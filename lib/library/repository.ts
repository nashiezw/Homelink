...
export async function getLibraryOrderForUser(orderId: string, userId: string, roles: string[] = []) {
  ...
  return {
    ...
    shippingMethod: typeof metadata.shippingMethod === "string" ? metadata.shippingMethod : null,
    pickupAddress: typeof metadata.pickupAddress === "string" ? metadata.pickupAddress : null,
    pickupInstructions: typeof metadata.pickupInstructions === "string" ? metadata.pickupInstructions : null,
    pickupPhone: typeof metadata.pickupPhone === "string" ? metadata.pickupPhone : null,
