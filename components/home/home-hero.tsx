...
export function HomeHero({ hero }: HomeHeroProps) {
  return (
    <section className="relative overflow-hidden bg-ink">
      ...
      <div className="relative mx-auto grid min-h-[640px] max-w-7xl items-center gap-10 px-4 pb-20 pt-16 sm:min-h-[720px] sm:px-6 sm:pb-28 sm:pt-20 lg:grid-cols-[1.08fr_0.92fr] lg:px-8">
        <div className="min-w-0 text-white">
          ...
          <h1 className="animate-fade-up mt-6 max-w-4xl text-4xl font-semibold leading-[1.05] tracking-tight text-white motion-reduce:animate-none sm:mt-7 sm:text-6xl lg:text-[4.25rem] [animation-delay:80ms]">
            {hero.title}{" "}
          ...
          <div className="animate-fade-up mt-6 max-w-4xl motion-reduce:animate-none sm:mt-8 [animation-delay:240ms]">
            <SearchBar />
          </div>

          <div className="animate-fade-up mt-5 flex flex-col gap-3 motion-reduce:animate-none sm:flex-row sm:flex-wrap [animation-delay:280ms]">
            <Link
              href={hero.primaryCta.href}
              className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-emerald-500 px-6 text-sm font-semibold text-white shadow-lg transition hover:-translate-y-0.5 hover:bg-emerald-400 sm:w-auto sm:rounded-xl"
            >
            ...
            <Link
              ...
              className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-lg border border-white/25 bg-white/10 px-6 text-sm font-semibold text-white backdrop-blur transition hover:bg-white/15 sm:w-auto sm:rounded-xl"
            >
