...
export function PageShell({
  ...
  return (
    <main className="academy-shell min-w-0 bg-mist dark:bg-slate-950">
      ...
      <section className="mx-auto min-w-0 max-w-7xl px-4 py-12 max-md:overflow-x-clip sm:px-6 lg:px-8">
        {children}
      </section>
    </main>
  );
