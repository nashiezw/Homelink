  ...
  return (
    <main className="academy-shell bg-mist dark:bg-slate-950">
      <section className="relative isolate overflow-hidden border-b border-emerald-900/20 bg-ink text-white">
        ...
        <div className={`relative z-10 mx-auto flex max-w-7xl flex-col justify-between gap-7 px-4 sm:px-6 lg:flex-row lg:gap-8 lg:px-8 ${compactHero ? "py-8 lg:items-center lg:py-10" : "py-10 lg:items-end lg:py-14"}`}>
          <div className="w-full min-w-0 sm:max-w-3xl lg:max-w-none">
            ...
            <h1 className={`mt-4 max-w-4xl font-semibold leading-tight tracking-normal text-white ${compactHero ? "text-[1.9rem] sm:text-4xl lg:text-[2.8rem]" : "text-[2rem] sm:text-4xl lg:text-5xl"}`}>
              {title}
            </h1>
