  ...
  return (
    <div className="flex flex-col gap-4 border-b border-white/[0.06] pb-6 lg:flex-row lg:items-end lg:justify-between">
      <div className="min-w-0">
        {eyebrow && (
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-400/90">{eyebrow}</p>
        )}
...
export function AdminTabStrip({
  ...
  return (
    <div className="flex flex-wrap gap-1 rounded-xl border border-white/[0.08] bg-slate-950/50 p-1">
      {tabs.map((tab) => (
        <button
          key={tab.id}
          type="button"
