    ...
    <div className="space-y-4">
      <div className="grid gap-3 rounded-xl border border-white/10 bg-slate-950/40 p-4 sm:grid-cols-2">
        ...
        <div className="grid gap-2 sm:flex sm:flex-wrap sm:justify-end">
          <Link href="/dashboard/admin/ai" className="inline-flex items-center gap-1 rounded-lg bg-white/10 px-3 py-2 text-sm text-white hover:bg-white/15">
            AI Control <ExternalLink className="size-3.5" />
          </Link>
          <Link href="/dashboard/admin/security" className="inline-flex items-center gap-1 rounded-lg bg-white/10 px-3 py-2 text-sm text-white hover:bg-white/15">
            Security & Audit <ExternalLink className="size-3.5" />
          </Link>
          <Link href="/dashboard/admin/payments" className="inline-flex items-center gap-1 rounded-lg bg-white/10 px-3 py-2 text-sm text-white hover:bg-white/15">
          ...
          <label className="flex items-center gap-2 text-sm font-medium text-slate-200 sm:col-span-2">
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  contact: { ...settings.contact, stickyWhatsAppEnabled: e.target.checked },
                })
              }
            />
