  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-2 sm:flex sm:flex-wrap">
        ...
        <Button variant="secondary" onClick={() => void load()} aria-label="Refresh property management requests">
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="max-h-[88vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-white/10 bg-slate-950 shadow-2xl">
        ...
        <div className="space-y-4 p-5">
          ...
          {canDeliver && (
            <div className="grid gap-2 sm:flex sm:flex-wrap rounded-xl border border-white/10 bg-white/[0.03] p-3">
