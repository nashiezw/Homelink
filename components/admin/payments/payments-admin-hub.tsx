...
export function PaymentsAdminHub() {
  ...
  function downloadReceipt(payment: Payment) {
    ...
    a.href = url;
    a.download = `houselink-receipt-${payment.receiptNumber ?? payment.id}.html`;
    a.click();
...
<head>
  ...
  <title>HouseLink Receipt ${escapeHtml(receiptNumber)}</title>
  <style>
...
<body>
  <main class="page">
    ...
    <section class="content">
      ...
      <p class="footer">
        This receipt was generated by HouseLink Zimbabwe. Keep it for your records. For questions, contact HouseLink support and quote the receipt number above.
      </p>
    </section>
  </main>
</body>
