...
export const academySubTabs: Record<AcademyPrimaryTab, Array<{ id: string; label: string }>> = {
  ...
  Learners: [
    ...
    { id: "Learner Activation", label: "Activation" },
    { id: "Student Analytics", label: "Student Analytics" },
    { id: "Coupons", label: "Coupons" },
    { id: "Certificates", label: "Certificates" },
    { id: "Certificate Templates", label: "Templates" },
    { id: "Certificate Monitoring", label: "Monitoring" },
    { id: "Assignment Review", label: "Assignments" },
  ],
  Library: [
...
export function resolveAcademyNav(requested?: string | null): { primary: AcademyPrimaryTab; sub: string } {
  const legacyMap: Record<string, { primary: AcademyPrimaryTab; sub: string }> = {
    ...
    "Learner Activation": { primary: "Learners", sub: "Learner Activation" },
    "Student Analytics": { primary: "Learners", sub: "Student Analytics" },
    Coupons: { primary: "Learners", sub: "Coupons" },
    Certificates: { primary: "Learners", sub: "Certificates" },
    "Certificate Templates": { primary: "Learners", sub: "Certificate Templates" },
    "Certificate Monitoring": { primary: "Learners", sub: "Certificate Monitoring" },
    "Assignment Review": { primary: "Learners", sub: "Assignment Review" },
