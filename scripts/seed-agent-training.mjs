...
const agentTrainingModules = [
  {
    ...
    resources: [{ id: "agent_starter_guide", title: "Agent starter guide", description: "A quick operating guide for new HomeLink agents.", url: "/resources/agents/homelink-agent-starter-guide.md", type: "PDF" }],
  },
  {
    id: "train_listings",
  ...
  },
  {
    ...
    resources: [{ id: "lead_handling_playbook", title: "Lead handling playbook", description: "Scripts, statuses, and safe viewing workflow for agent leads.", url: "/resources/agents/lead-handling-playbook.md", type: "PDF" }],
  },
  {
    id: "train_compliance",
    ...
    resources: [{ id: "compliance_handbook", title: "Compliance and ethics handbook", description: "Practical operating rules for privacy, documentation, and marketplace safety.", url: "/resources/agents/compliance-ethics-handbook.md", type: "PDF" }],
  },
  {
    id: "train_pm",
    ...
    resources: [{ id: "pm_operations", title: "Property management operations guide", description: "Process guide for managed property requests.", url: "/resources/agents/property-management-operations.md", type: "PDF" }],
  },
  {
    id: "train_growth",
    ...
    resources: [{ id: "commission_growth", title: "Commission and growth guide", description: "Guide to earning, reviews, profile quality, and progression.", url: "/resources/agents/commission-and-growth-guide.md", type: "PDF" }],
  },
];
