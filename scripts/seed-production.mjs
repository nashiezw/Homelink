...
const agentTrainingModules = [
  {
    ...
    resources: [
      { id: "agent_starter_guide", title: "Agent starter guide", description: "A quick operating guide for new HomeLink agents.", url: "/resources/agents/homelink-agent-starter-guide.md", type: "PDF" },
    ],
  },
  {
    id: "train_listings",
    ...
    resources: [
      { id: "listing_quality_checklist", title: "Listing quality checklist", description: "Inspection and publishing checklist for rentals, sales, rooms, and holiday homes.", url: "/resources/agents/listing-quality-checklist.md", type: "CHECKLIST" },
      { id: "viewing_inspection_sheet", title: "Viewing inspection sheet", description: "Reusable worksheet for property viewings and inspections.", url: "/resources/agents/viewing-inspection-sheet.md", type: "TEMPLATE" },
    ],
  },
  {
    id: "train_leads",
    ...
    resources: [
      { id: "lead_handling_playbook", title: "Lead handling playbook", description: "Scripts, statuses, and safe viewing workflow for agent leads.", url: "/resources/agents/lead-handling-playbook.md", type: "PDF" },
    ],
  },
  {
    id: "train_compliance",
    ...
    resources: [
      { id: "compliance_handbook", title: "Compliance and ethics handbook", description: "Practical operating rules for privacy, documentation, and marketplace safety.", url: "/resources/agents/compliance-ethics-handbook.md", type: "PDF" },
    ],
  },
  {
    id: "train_pm",
    ...
    resources: [
      { id: "pm_operations", title: "Property management operations guide", description: "Process guide for managed property requests.", url: "/resources/agents/property-management-operations.md", type: "PDF" },
    ],
  },
  {
    id: "train_growth",
    ...
    resources: [
      { id: "commission_growth", title: "Commission and growth guide", description: "Guide to earning, reviews, profile quality, and progression.", url: "/resources/agents/commission-and-growth-guide.md", type: "PDF" },
    ],
  },
];
      ...
      await prisma.agentTrainingProgressRecord.upsert({
        ...
        update: {
          ...
          payload: {
            ...
            submittedAnswers: trainingModule.id === "train_leads" ? answerKey : {},
            completedAt: now,
