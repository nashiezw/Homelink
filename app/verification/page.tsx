      ...
      <section className="mt-10 grid gap-8 lg:grid-cols-[1fr_0.9fr]">
        ...
        <aside className="surface-panel h-fit rounded-lg p-6">
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/report-listing"
              className="inline-flex min-h-11 w-full items-center justify-center rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-500 sm:w-auto"
            >
              Report a listing
            </Link>
            <Link
              href="/contact"
              className="inline-flex min-h-11 w-full items-center justify-center rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-600 dark:text-slate-200 sm:w-auto"
            >
