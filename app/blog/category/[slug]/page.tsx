    ...
    <main className="bg-mist text-slate-950 dark:bg-slate-950 dark:text-white">
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          <nav className="mb-7 flex flex-wrap gap-2 text-sm text-slate-300" aria-label="Breadcrumb">
          ...
          <h1 className="mt-3 max-w-4xl text-4xl font-semibold tracking-normal sm:text-5xl">{data.category.name}</h1>
          <p className="mt-4 max-w-2xl text-slate-300">{data.category.description}</p>
