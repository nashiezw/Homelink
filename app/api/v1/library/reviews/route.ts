...
import { createLibraryCustomerReview } from "@/lib/library/repository";
...
export async function POST(request: Request) {
  ...
  if ("error" in result && result.error === "PURCHASE_REQUIRED") {
    return problem(403, "PURCHASE_REQUIRED", "You can review products after you have Library download access.");
  }
